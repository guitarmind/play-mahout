...
public class ItemLookupSample {
	 ...
	 */
	private static final String AWS_ACCESS_KEY_ID = "AKIAJ425K6RSWW7GZMMA";

	/*
	 * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
	 * Your Account page.
	 */
	private static final String AWS_SECRET_KEY = "SnekyoHJh6p9jXD5FFZiWEuvwYTvoqpVZqo5dfr9";
	...
	public static void main(String[] args) {
		...
		// String queryString =
		// "AssociateTag=n018b7-20&Service=AWSECommerceService&Version=2009-03-31&Operation=ItemLookup&ResponseGroup=Small&ItemId="
		// + ITEM_ID;
		//
	...
	private static String fetchFieldValue(String requestUrl, String targetField) {
		String output = null;
		try {
			DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
			DocumentBuilder db = dbf.newDocumentBuilder();
			Document doc = db.parse(requestUrl);
			Node node = doc.getElementsByTagName(targetField).item(0);
