...
public class TokenCountFeatureExtractor implements Runnable {
	...
	public TokenCountFeatureExtractor(String htmlFolderPath,
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < 6; i++) {
			...
			TokenCountFeatureExtractor worker = new TokenCountFeatureExtractor(
