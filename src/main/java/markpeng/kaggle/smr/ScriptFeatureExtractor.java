...
public class ScriptFeatureExtractor implements Runnable {
	...
	public ScriptFeatureExtractor(String htmlFolderPath, String tagFilePath,
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < 6; i++) {
			...
			ScriptFeatureExtractor worker = new ScriptFeatureExtractor(
