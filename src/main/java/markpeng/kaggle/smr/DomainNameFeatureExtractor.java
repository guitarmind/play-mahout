...
public class DomainNameFeatureExtractor implements Runnable {
	...
	public DomainNameFeatureExtractor(String htmlFolderPath,
			String tagFilePath, Hashtable<String, String> trainFileList,
			...
			if (checker.exists()) {
				...
				for (String file : files) {
					...
					try {
						...
						String html = htmlStr.toString();

						// get tag counts
						int tindex = 0;
						for (String t : tagList) {
							int count = StringUtils.countMatches(html, t);
							if (tindex != tagList.size() - 1)
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < 6; i++) {
			...
			DomainNameFeatureExtractor worker = new DomainNameFeatureExtractor(
