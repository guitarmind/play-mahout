...
public class MapReduceNaiveBayesPredictor {
	public static class ClassifierMap extends
	...
	public static void main(String[] args) throws Exception {
		if (args.length < 5) {
			System.out
					.println("Arguments: [model] [dictionnary] [document frequency] [tweet file] [output directory]");
			return;
		}
		...
		conf.setStrings(NaiveBayesClassifier.MODEL_PATH_CONF, modelPath);
		conf.setStrings(NaiveBayesClassifier.DICTIONARY_PATH_CONF,
				dictionaryPath);
		conf.setStrings(NaiveBayesClassifier.DOCUMENT_FREQUENCY_PATH_CONF,
